...
class L3CGConv(torch.nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = CGConv(in_channels,  out_channels)
        self.conv2 = CGConv( out_channels, out_channels)
        self.conv3 = CGConv( out_channels, out_channels)
        self.drop  = dropout(p=0.1)
...
class L2CGConv(torch.nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = CGConv(in_channels, MAX_CHANNELS * out_channels)
        self.conv2 = CGConv(MAX_CHANNELS * out_channels, out_channels)
        self.drop  = dropout(p=0.1)
